...
private:
  ...
  enum StatBins {
  BIN_nEvents = 0,
    BIN_HLT_DoubleMu3_Upsilon = 1,
    BIN_HLT_L1DoubleMu0 = 2,
    BIN_HLT_DoubleMu0 = 3,
    BIN_HLT_L1DoubleMuOpen = 4, 
    BIN_HLT_L1DoubleMuOpen_Tight =5,
    BIN_HLT_L2DoubleMu0=6,
    BIN_HLT_Mu0_L1MuOpen=7,  
    BIN_HLT_Mu0_L2Mu0=8, 
    BIN_HLT_Mu0_Track0_Jpsi=9,
    BIN_HLT_Mu0_TkMu0_OST_Jpsi=10
  };
  ...
  _iConfig(iConfig)
{
  ...
  HLTLastFilters[0] = "";
  HLTLastFilters[1] = "hltDoubleMu3UpsilonL3Filtered"; // Upsi
  HLTLastFilters[2] = "hltDiMuonL1Filtered0"; // Upsi
  // HLTLastFilters[3] = "hltDiMuonL3PreFiltered0"; // HLT_DoubleMu0
  //  HLTLastFilters[4] = "hltDoubleMuLevel1PathL1OpenFiltered";
   // HLTLastFilters[5] = "hltL1DoubleMuOpenTightL1Filtered";
  //  HLTLastFilters[6] = "hltDiMuonL2PreFiltered0";
 //   HLTLastFilters[7] = "hltMu0L1MuOpenL3Filtered0";
  //  HLTLastFilters[8] = "hltMu0L2Mu0L3Filtered0";
  //  HLTLastFilters[9] = "hltMu0TrackJpsiTrackMassFiltered";
  //  HLTLastFilters[10] = "hltMu0TkMuJpsiTkMuMassFiltered";
 ...
 //  HLTLastFilters[2] = "hltHIL2DoubleMu3L2Filtered";             // BIT HLT_HIL2DoubleMu3
  ...
  theTriggerNames.push_back("HLT_DoubleMu3_Upsilon_v*");
  theTriggerNames.push_back("HLT_L1DoubleMu0_v*");
  //theTriggerNames.push_back("HLT_DoubleMu0");
  //theTriggerNames.push_back("HLT_L1DoubleMuOpen");
  //theTriggerNames.push_back("HLT_L1DoubleMuOpen_Tight");
  //theTriggerNames.push_back("HLT_L2DoubleMu0");
  //theTriggerNames.push_back("HLT_Mu0_L1MuOpen");
  //theTriggerNames.push_back("HLT_Mu0_L2Mu0");
  //theTriggerNames.push_back("HLT_Mu0_Track0_Jpsi");
  //theTriggerNames.push_back("HLT_Mu0_TkMu0_OST_Jpsi");
...
HiOniaAnalyzer::selTrackerMuon(const pat::Muon* aMuon) {
  ...
  return ( aMuon->userFloat("vProb") > 0.01 );
